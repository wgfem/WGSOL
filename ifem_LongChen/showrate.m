...
if exist('opt','var')
    ...
    set(h,'linewidth',2);
    hold on
    h = loglog(N,s*N.^r,'k-.','linewidth',1);
    %set(h,'linewidth',1,'linestyle','k-.');    
else
...
if exist('str','var')
%     h_legend = legend(str,['Ch^{' num2str(r,2) '}'],'LOCATION','Best');
%     set(h_legend,'FontSize', 14);
    title(['Convergence in ',str,'is Ch^{' num2str(r,2) '}'],'FontSize', 14);
else
    title(['Convergence is Ch^{' num2str(r,2) '}'],'FontSize', 14); 
end