function [u,AD,b,ers,info] = ...
          Diffusion_Convection_SWG_quadrangle(node,elem,pde,bdFlag,option)
% This is to solve the convection diffusion equation on quadrangle partition.
%
%   u = Diffusion_Convection_SWG_quadrangle(node,elem,pde,bdFlag,option) 
...
%   
%   The function Diffusion_Convection_SWG_quadrangle assembes the matrix 
