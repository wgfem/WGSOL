function [u,AD,b,ers,info] = Poisson_SWG_quadrangle(node,elem,pde,bdFlag,option)
% This is to solve the Poisson equation on quadrangle partition.
%
%   u = Poisson_SWG_quadrangle(node,elem,pde,bdFlag,option) produces the linear
...
%   
%   The function Poisson_SWG_quadrangle assembes the matrix equation AD*u = b 
...
%
%    MyElement=struct('Edge', MyEdge_info, 'NumberEdge', num_edge);
%    MyElement.Edge  
%    pause
%
